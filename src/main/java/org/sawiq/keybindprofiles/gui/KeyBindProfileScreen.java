...
public class KeyBindProfileScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.fill((width - BUTTON_WIDTH) / 2 - 5, START_Y - 5, (width + BUTTON_WIDTH) / 2 + 5, height - FOOTER_HEIGHT + 5, 0x40000000);

        super.render(context, mouseX, mouseY, delta);

        int titleWidth = textRenderer.getWidth(title);
        context.drawText(textRenderer, title, (width - titleWidth) / 2, 10, 0xFFFFFF, false);
